...
SELECT CONCAT(first_name," ",last_name) AS customer_name, address FROM customer
...
SELECT CONCAT(first_name,' ',last_name) AS customer_name, country, LENGTH(country) FROM customer
LEFT JOIN address ON customer.address_id = address.address_id
LEFT JOIN city ON address.city_id = city.city_id
LEFT JOIN country ON city.country_id = country.country_id
...
SELECT CONCAT(first_name," ",last_name) AS customer_name, country, city, LENGTH(city) AS city_name_length FROM customer
LEFT JOIN address ON customer.address_id = address.address_id
LEFT JOIN city ON address.city_id = city.city_id
LEFT JOIN country ON city.country_id = country.country_id
...
SELECT CONCAT(first_name," ",last_name) AS customer_name, city FROM customer
LEFT JOIN address ON customer.address_id = address.address_id
LEFT JOIN city ON address.city_id = city.city_id
WHERE city LIKE "%ba%";
...
SELECT CONCAT(first_name," ",last_name) AS customer_name, city, LENGTH(city) AS city_name_length FROM customer
LEFT JOIN address ON customer.address_id = address.address_id
LEFT JOIN city ON address.city_id = city.city_id
WHERE city LIKE "% %"
ORDER BY city_name_length DESC;
-- 13. Get all the customers where the country name is longer than the city name.
SELECT CONCAT(first_name,' ',last_name) AS customer_name, city, country, LENGTH(city) AS city_name_length, LENGTH(country) country_name_length FROM customer
LEFT JOIN address ON customer.address_id = address.address_id
LEFT JOIN city ON address.city_id = city.city_id
LEFT JOIN country ON city.country_id = country.country_id
